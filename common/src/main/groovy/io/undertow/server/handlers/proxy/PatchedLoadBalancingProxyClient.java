 ...
 */
public class PatchedLoadBalancingProxyClient implements ProxyClient {
    private static final Logger LOG = LoggerFactory.getLogger(PatchedLoadBalancingProxyClient.class);
    ...
    public PatchedLoadBalancingProxyClient() {
        this(UndertowClient.getInstance());
    }

    public PatchedLoadBalancingProxyClient(UndertowClient client) {
        this(client, null, null);
    }

    public PatchedLoadBalancingProxyClient(ExclusivityChecker client) {
        this(UndertowClient.getInstance(), client, null);
    }

    public PatchedLoadBalancingProxyClient(UndertowClient client, ExclusivityChecker exclusivityChecker) {
        this(client, exclusivityChecker, null);
    }

    public PatchedLoadBalancingProxyClient(UndertowClient client, ExclusivityChecker exclusivityChecker, HostSelector hostSelector) {
        this.client = client;
    ...
    public PatchedLoadBalancingProxyClient addSessionCookieName(final String sessionCookieName) {
        sessionCookieNames.add(sessionCookieName);
        return this;
    }

    public PatchedLoadBalancingProxyClient removeSessionCookieName(final String sessionCookieName) {
        sessionCookieNames.remove(sessionCookieName);
        return this;
    }

    public PatchedLoadBalancingProxyClient setProblemServerRetry(int problemServerRetry) {
    ...
    public PatchedLoadBalancingProxyClient setConnectionsPerThread(int connectionsPerThread) {
    ...
    public PatchedLoadBalancingProxyClient setMaxQueueSize(int maxQueueSize) {
        this.maxQueueSize = maxQueueSize;
        return this;
    }

    public PatchedLoadBalancingProxyClient setTtl(int ttl) {
        this.ttl = ttl;
        return this;
    }

    public PatchedLoadBalancingProxyClient setSoftMaxConnectionsPerThread(int softMaxConnectionsPerThread) {
        this.softMaxConnectionsPerThread = softMaxConnectionsPerThread;
        return this;
    }

    public synchronized PatchedLoadBalancingProxyClient addHost(final URI host) {
        return addHost(host, null, null);
    }

    public synchronized PatchedLoadBalancingProxyClient addHost(final URI host, XnioSsl ssl) {
        return addHost(host, null, ssl);
    }

    public synchronized PatchedLoadBalancingProxyClient addHost(final URI host, String jvmRoute) {
        return addHost(host, jvmRoute, null);
    }


    public synchronized PatchedLoadBalancingProxyClient addHost(final URI host, String jvmRoute, XnioSsl ssl) {
    ...
    public synchronized PatchedLoadBalancingProxyClient addHost(final URI host, String jvmRoute, XnioSsl ssl, OptionMap options) {
        return addHost(null, host, jvmRoute, ssl, options);
    }


    public synchronized PatchedLoadBalancingProxyClient addHost(final InetSocketAddress bindAddress, final URI host, String jvmRoute, XnioSsl ssl, OptionMap options) {
    ...
    public synchronized PatchedLoadBalancingProxyClient removeHost(final URI uri) {
        int found = -1;
        Host[] existing = hosts;
    ...
    protected Host selectHost(HttpServerExchange exchange) {
        ...
        //no available hosts
        LOG.warn("No available hosts: " + exchange);
        return null;
    }
